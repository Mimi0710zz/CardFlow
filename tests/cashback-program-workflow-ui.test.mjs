...
assert.match(css,/\.cashback-total-spend-control\{[^}]*display:flex[^}]*align-items:center[^}]*justify-content:flex-start[^}]*gap:(?:8|10|12)px[^}]*width:fit-content/);
assert.doesNotMatch(css,/\.cashback-total-spend-control\{[^}]*grid-template-columns/);
assert.match(css,/\.cashback-total-spend-control \.cashback-money-input\{[^}]*width:min\((?:260|280|300|320)px,100%\)/);
